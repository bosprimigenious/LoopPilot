...
36. [logs/2026-06-20-0.9-release-candidate-spec.md](logs/2026-06-20-0.9-release-candidate-spec.md)：**0.9 RC / Stability Freeze 规划决策日志**。
36. [logs/2026-06-20-mini-mvp-delivery.md](logs/2026-06-20-mini-mvp-delivery.md)：0.1 Mini-MVP 交付与验证日志。
...
- **阶段版本与推进顺序以 `33-version-roadmap.md` 为准**；**0.5 发布规格以 `34-version-roadmap-0x.md` §6 为准**；**0.9 RC / freeze 规格以 `34-version-roadmap-0x.md` §10 为准**。
...
- 当前行动项以 `33-next-steps-0.2.md` 为准。
