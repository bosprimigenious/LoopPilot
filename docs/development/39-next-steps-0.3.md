...
[已完成] 0.2 practical-mvp  ← v0.2.0a1 (2026-06-21)
    ↓
[当前]   0.3 adapter-mvp    ← 分支 adapter-mvp-0.3
    ↓
...
- [ ] `git checkout -b adapter-mvp-0.3 v0.2.0a1`（或从 main 等效 commit）
- [ ] 阅读 [36-adapter-mvp-0.3-acceptance.md](36-adapter-mvp-0.3-acceptance.md)
- [ ] 阅读 [37-adapter-safety-policy.md](37-adapter-safety-policy.md)
- [ ] 阅读 [38-toolbroker-design.md](38-toolbroker-design.md)
