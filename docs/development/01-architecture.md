...
```text
L0 Trigger
   CLI / OS Scheduler / Manual Resume
        ↓
L1 Control Plane
...
L4 Capabilities
   Agents / Skills / Tools / Connectors / Model Router
        ↓
L5 State & Evidence
   SQLite / Checkpoints / Workspaces / Artifacts / Markdown Reports
```
...
| 组件 | 唯一职责 |
|---|---|
| CLI | 接收 run、resume、approve、cancel、status 命令 |
